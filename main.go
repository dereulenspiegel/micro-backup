...
import (
	...
	"github.com/dereulenspiegel/micro-backup/controllers"
...
func main() {
	...
	flag.StringVar(&jobControllerOpts.DefaultCommand, "backup-default-command", "restic --verbose backup /targetPvc", "Command to run by default in the backup container")
	opts := zap.Options{
		Development: true,
	}
